# Find Subdomain Using Wayback Machine
- `waybacksub` is an Automation Tool to find Subdomains with Wayback Machine.
- Just use `waybacksub target.com` to Run Tool Automatically.
...
### Steps to Install:
```sh
git clone https://github.com/PushkraJ99/waybacksub.git
cd waybacksub
sudo bash install.sh
```
### Opem New Terminal & Run 
```
waybacksub target.com
```
